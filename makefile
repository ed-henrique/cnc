...
client:
	...
	client_fn/socket_related.c general_fn/compress_related.c general_fn/conversion_related.c -lz -o client
...
server:
	...
	general_fn/conversion_related.c server_fn/options_related.c -lz -o server
